...
public class Tablero extends JFrame
{
    ...
    //private final String start = "abcdefghijknmo0l";
    //private final String goal  = "abcdefghijklmno0.";
    
    //private final String start = "abcdeghlifkomjn0";
    //private final String goal  = "abcdefghijklmno0.";
    
    //private final String start = "abcdefghijkl0nop";
    //private final String goal  = "0bcdafghejklinop"; 
    
    //private final String start = "abcdjikfng0hemol";
    //private final String goal  = "abcdefghijklmno0.";
    
    //Ninguno
    private final String start = "abcje0nhikdfmogl";
    private final String goal  = "abcdefghijklmno0.";
    ...
    private final int maxDept = 1000; // Para limitar la profundidad del árbol
    ...
    private void initComponents() 
    {
        ...
        this.setLayout(null);
        this.imagePieces("imagenes/miniatura.jpg");
        paintPieces();
    ...
    public void paintPieces()
    {
        ...
        for(int i=0;i<4;i++)
            for(int j=0;j<4;j++){
                ...
                this.add(jBoard[i][j]);   
                if(!k.equals("0")){
                    jBoard[i][j].setIcon(new ImageIcon(subImage));
                }
                else empty = subImage;
                n++;                 
            }
    ...
    private void solve(){
        try{
            ...
            while(!queue.isEmpty() && !success && !deepCond){
                ...
                for(State ns: next){
                    //System.out.println(ns.movement);
            ...
            { 
                JOptionPane.showMessageDialog(rootPane, "Path not found", "Limite de memoria/tiempo!!!", JOptionPane.WARNING_MESSAGE);
                System.out.println("Path not found");
            }
        }
        catch(OutOfMemoryError  e){
            JOptionPane.showMessageDialog(rootPane, "Hay demasiados caminos para buscar", "Sorry!!!", JOptionPane.WARNING_MESSAGE);
